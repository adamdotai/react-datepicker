...
import DatePicker, { DatePickerProvider } from 'react-datepicker';
import DateFnsAdapter from '@date-io/date-fns';
import HijriAdapter from '@date-io/hijri';
import 'moment/locale/ar-sa';

const dateFns = new DateFnsAdapter();
const hijriAdapter = new HijriAdapter();
    ...
    <DatePickerProvider adapter={dateFns}>
        <div>
            ...
            <div className="wrapper">
                ...
                <p>
                    Below are examples which also can be edited directly via the
                    editor on the left side and will be rendered on the right.
                </p>
            </div>
            <div className="wrapper">
                <ExampleComponents />
