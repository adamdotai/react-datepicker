...
describe('MonthYearDropdown', () => {
    ...
    describe('scroll mode', () => {
        ...
        it('shows the selected month year in the initial view', () => {
            const selected_month_year_name = formatDate(
                selectedDate,
                'LLLL yyyy'
            );
            expect(monthYearDropdown.text()).to.contain(
        ...
        it('closes the dropdown when a month year is clicked', () => {
            ...
            monthYearDropdown
                ...
                .simulate('click');
            expect(
                monthYearDropdown.find(MonthYearDropdownOptions)
            ).to.have.length(0);
        });
        ...
        it('calls the supplied onChange function when a different month year is clicked', () => {
            ...
            monthYearDropdown
                ...
                .at(5)
                .simulate('click');
            expect(handleChangeResult.toString()).to.eq(
    ...
    describe('select mode', () => {
        ...
        it('calls the supplied onChange function when a different month is clicked', () => {
            ...
            expect(handleChangeResult.valueOf()).to.equal(
                monthToClick.valueOf()
            );
        });
    });
});
