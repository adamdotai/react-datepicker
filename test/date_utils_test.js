import {
    ...
    yearsDisabledBefore,
    getYear,
} from '../src/__date_utils';
import setMinutes from 'date-fns/setMinutes';
import setHours from 'date-fns/setHours';
import ptBR from 'date-fns/locale/pt-BR';
import { registerLocale } from '../src/__date_utils';
...
describe('date_utils', function () {
    ...
    describe('isEqual', function () {
        ...
        it('should return false for non-equal date and date with time', function () {
            expect(isEqual(newDate('2016-02-10'), newDate('2016-02-11 13:13')))
                .to.be.false;
        });
        ...
        it('should return false for non-equal time', function () {
            expect(
                isEqual(
                    newDate('2016-02-10 13:13'),
                    newDate('2016-02-11 13:14')
                )
            ).to.be.false;
        });
    ...
    describe('isSameDay', function () {
        ...
        it('should return false for non-equal dates', function () {
            expect(isSameDay(newDate('2016-02-10'), newDate('2016-02-11'))).to
                .be.false;
        });

        it('should return true for equal dates', function () {
            expect(isSameDay(newDate('2016-02-10'), newDate('2016-02-10'))).to
                .be.true;
        });
    });
    ...
    describe('isSameMonth', function () {
        ...
        it('should return false for non-equal months ', function () {
            expect(isSameMonth(newDate('2016-02-10'), newDate('2016-03-10'))).to
                .be.false;
        });

        it('should return true for equal months', function () {
            expect(isSameMonth(newDate('2016-02-10'), newDate('2016-02-29'))).to
                .be.true;
        });
    });
    ...
    describe('isSameQuarter', function () {
        ...
        it('should return false for non-equal quarters ', function () {
            expect(isSameQuarter(newDate('2016-02-10'), newDate('2016-04-10')))
                .to.be.false;
        });

        it('should return true for equal quarters', function () {
            expect(isSameQuarter(newDate('2016-02-10'), newDate('2016-03-29')))
                .to.be.true;
        });
    });
    ...
    describe('isSameYear', function () {
        ...
        it('should return false for non-equal years ', function () {
            expect(isSameYear(newDate('2016-02-10'), newDate('2015-02-10'))).to
                .be.false;
        });

        it('should return true for equal years', function () {
            expect(isSameYear(newDate('2016-02-10'), newDate('2016-12-24'))).to
                .be.true;
        });
    });
    ...
    describe('getEffectiveMinDate', () => {
        ...
        it('should return the minimum include date satisfying the min date', () => {
            ...
            const includeDates = [date1, date2];
            assert(
                isEqual(getEffectiveMinDate({ minDate, includeDates }), date2)
            );
        });
    });
    ...
    describe('getEffectiveMaxDate', () => {
        ...
        it('should return the maximum include date satisfying the max date', () => {
            ...
            const includeDates = [date1, date2];
            assert(
                isEqual(getEffectiveMaxDate({ maxDate, includeDates }), date1)
            );
        });
    });
    ...
    describe('isTimeInDisabledRange', () => {
        it('should tell if time is in disabled range', () => {
            ...
            expect(isTimeInDisabledRange(time, { minTime, maxTime })).to.be
                .false;
        });
