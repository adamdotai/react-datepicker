...
describe('Day', () => {
    ...
    describe('in selecting range', () => {
        ...
        describe('for a start date picker', () => {
            ...
            it('should have a class if it is a start or end date', () => {
                ...
                expect(shallowStartDay.hasClass(rangeDayStartClassName)).to.be
                    .true;
                ...
                expect(shallowMidRangeDay.hasClass(rangeDayStartClassName)).to
                    .be.false;
                expect(shallowMidRangeDay.hasClass(rangeDayEndClassName)).to.be
                    .false;
    ...
    describe('aria-label', () => {
        ...
        it('should have the correct provided prefix if date is not disabled', () => {
            ...
            expect(
                shallowDay
                    .html()
                    .indexOf(`aria-label="${ariaLabelPrefixWhenEnabled}`)
            ).not.equal(-1);
        });
        ...
        it('should have the correct provided prefix if date is disabled', () => {
            ...
            expect(
                shallowDay
                    .html()
                    .indexOf(`aria-label="${ariaLabelPrefixWhenDisabled}`)
            ).not.equal(-1);
        });
    });
    ...
    describe('for a start date picker with selectsRange prop', () => {
        ...
        it('should have a class if it is a start or end date', () => {
            ...
            expect(shallowMidRangeDay.hasClass(rangeDayStartClassName)).to.be
                .false;
            expect(shallowMidRangeDay.hasClass(rangeSetDayClassName)).to.be
                .true;
            expect(shallowMidRangeDay.hasClass(rangeDayEndClassName)).to.be
                .false;
